...
import { ActivityIndicator, FlatList, SafeAreaView, StyleSheet, Text, TouchableOpacity, View, Alert } from 'react-native';
  ...
  const handleSignOut = () => {
    signOut(auth)
      ...
      .catch((error) => {
        ...
        Alert.alert('Error', 'No se pudo cerrar la sesión en este momento. Inténtalo de nuevo.');
      });
  };
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <View style={styles.cardBody}>
              ...
              <Text style={styles.viewMoreText}>Ver detalles y participar →</Text>
            </View>
          </TouchableOpacity>
        )}
        ListEmptyComponent={
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '800', color: '#2C3E50', flex: 1, marginRight: 10 },
  logoutButton: { backgroundColor: '#FEE2E2', paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8, borderWidth: 1, borderColor: '#FCA5A5' },
  ...
  card: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 18, marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 3 },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 },
  eventName: { fontSize: 18, fontWeight: '700', color: '#34495E', flex: 1, marginRight: 10 },
  dateBadge: { backgroundColor: '#E8F0FE', paddingVertical: 6, paddingHorizontal: 10, borderRadius: 8 },
  ...
  eventDescription: { fontSize: 14, color: '#95A5A6', lineHeight: 20, marginBottom: 8 },
  viewMoreText: { fontSize: 13, color: '#4A90E2', fontWeight: '600', textAlign: 'right' },
  ...
  fab: { position: 'absolute', width: 60, height: 60, alignItems: 'center', justifyContent: 'center', right: 20, bottom: 30, backgroundColor: '#4A90E2', borderRadius: 30, shadowColor: '#4A90E2', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 8, elevation: 8 },
